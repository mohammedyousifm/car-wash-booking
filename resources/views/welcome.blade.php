        ...
        <div class="container mx-auto px-4 py-16 md:py-24 relative z-10">
            <div class="flex flex-col md:flex-row items-center">
                <div class="md:w-1/2 mb-10 md:mb-0 car-slide-in">
                    <h1 class="text-4xl md:text-5xl font-bold mb-6">غسل معنا ووفر بنزين سيارتك</h1>
                    <p class="text-lg md:text-xl mb-8 text-blue-100">الخيار الأول والمفضل لعملاء غسيل السيارات في
                        المملكة العربية السعودية، من خلال تقديم تجربة مميزة ومريحة للعملاء وتوفير خدمات غسيل السيارات
                        بجودة عالية.</p>

                    <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-8">
                        <a href="#booking"
                            class="bg-white text-blue-600 hover:bg-blue-50 px-6 py-3 rounded-lg font-semibold text-center transition duration-300 shadow-lg">
                    ...
                    <div class="flex items-center">
                        ...
                        <p class="text-blue-100">انضم إلى أكثر من 10000 عميل سعيد</p>
                    </div>
                </div>
                ...
                <div class="md:w-1/2 relative">
                    <div
                        ...
                        <img src="https://jungleworks.com/wp-content/uploads/2018/08/group-6-5-1.png"
                            alt="Luxury car being washed" class="rounded-lg w-full mb-4">
                        <div class="flex justify-between items-center">
                            <div>
                                <h3 class="text-gray-800 font-semibold">غسيل ممتاز + شمع</h3>
    ...
    <section class="section  services" id="services">
        ...
        <div class="text-center">
            <div class="section-title animate-fade-up">
                <h2>الخدمات</h2>
                <p>نحن نقدم مجموعة متنوعة من خدمات غسيل السيارات عالية الجودة</p>
            </div>
            ...
            <div class="services-grid">
                <div class="service-card animate-fade-up">
                    ...
                    <h3 class="service-title">الغسيل الخارجي</h3>
                    <p class="service-desc">غسيل خارجي ممتاز للسيارة مع تنظيف العجلات والإطارات واستخدام منتجات عالية
                        الجودة</p>
                ...
                <div class="service-card animate-fade-up">
                    ...
                    <h3 class="service-title">التنظيف الداخلي</h3>
                    <p class="service-desc">تنظيف شامل للمقصورة الداخلية مع تعقيم وإزالة الروائح وتلميع الأسطح</p>
                    <a href="#" class="btn-primary">المزيد</a>
                </div>
                ...
                <div class="service-card animate-fade-up">
                    ...
                    <h3 class="service-title">التلميع والحماية</h3>
                    <p class="service-desc">تلميع احترافي للسيارة مع طبقة حماية لطلاء السيارة تدوم طويلاً</p>
                    <a href="#" class="btn-primary">المزيد</a>
                </div>
            </div>
        </div>
            ...
            <div class="p-6 md:p-8 space-y-8">
                <div class="step-container">
                    ...
                    <div class="step-content p-4">
                        ...
                        <p class="text-gray-600">اختر من بين مجموعة متنوعة من خدمات غسيل السيارات المتميزة لدينا، مثل
                            الغسيل
                            العادي، الغسيل الممتاز، أو الغسيل مع التشميع.</p>
                    </div>
                </div>
                ...
                <div class="step-container">
                    ...
                    <div class="step-content p-4">
                        ...
                        <p class="text-gray-600">استرخِ واترك الباقي علينا! سنصل إليك في الوقت المحدد لنقدم لك خدمة غسيل
                            سيارات لا مثيل لها.</p>
                    </div>
                </div>
            ...
            <div class="faq-container">
                <div class="faq-item animate-fade-up">
                    <div class="faq-question">
                        <span>كيف يمكنني طلب خدمة غسيل السيارات؟</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>يمكنك طلب خدمة غسيل السيارات بسهولة من خلال تطبيقنا المتوفر على متجر آبل وجوجل بلاي، أو من
                            خلال موقعنا الإلكتروني. كل ما عليك هو تحديد موقعك، واختيار الباقة المناسبة، وتحديد الوقت
                            المناسب، وسيقوم فريقنا بالحضور إليك أينما كنت.</p>
                    </div>
                </div>

                <div class="faq-item animate-fade-up">
                    <div class="faq-question">
                        <span>ما هي مدة خدمة غسيل السيارات؟</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>تستغرق خدمة الغسيل الأساسية حوالي 30-45 دقيقة، بينما قد تستغرق الباقة الشاملة حوالي 60-90
                            دقيقة. أما بالنسبة للباقة الاحترافية التي تشمل التلميع وطبقة الحماية، فقد تستغرق من 2-3
                            ساعات حسب حجم السيارة وحالتها.</p>
                    </div>
                </div>

                <div class="faq-item animate-fade-up">
                    <div class="faq-question">
                        <span>هل تستخدمون منتجات آمنة على طلاء السيارة؟</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>نعم، نحن نستخدم فقط منتجات عالية الجودة وآمنة تماماً على طلاء السيارة. جميع المنتجات التي
                            نستخدمها صديقة للبيئة ومصممة خصيصاً للحفاظ على جودة طلاء السيارة وحمايتها من التلف.</p>
                    </div>
                </div>

                <div class="faq-item animate-fade-up">
                    <div class="faq-question">
                        <span>هل يمكنني إلغاء أو إعادة جدولة موعد الغسيل؟</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>نعم، يمكنك إلغاء أو إعادة جدولة موعد الغسيل قبل ساعتين على الأقل من الموعد المحدد دون أي رسوم
                            إضافية. يمكنك القيام بذلك من خلال التطبيق أو من خلال الاتصال بخدمة العملاء.</p>
                    </div>
                </div>

                <div class="faq-item animate-fade-up">
                    <div class="faq-question">
                        <span>هل تقدمون خدمات غسيل السيارات في جميع المدن؟</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>حالياً، نقدم خدماتنا في المدن الرئيسية في المملكة العربية السعودية مثل الرياض، جدة، الدمام،
                            والخبر. ونعمل على التوسع لتغطية مزيد من المدن في المستقبل القريب. يمكنك التحقق من تغطيتنا من
                            خلال تطبيقنا أو موقعنا الإلكتروني.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="md:w-2/3 p-8">
                        <form method="Post" action="{{ route('booking') }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div class="mb-6">
                                    <label class="block text-gray-700 mb-2">نوع المركبة</label>
                                ...
                                <div class="mb-6">
                                    ...
                                    <select name="service_type"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        <option value="غسيل أساسي (200 ريال)">غسيل أساسي (200 ريال)</option>
                                        <option value="غسيل ممتاز (300 ريال)">غسيل ممتاز (300 ريال)</option>
                                        <option value="الباقة الفاخرة (500 حقيقية)">الباقة الفاخرة (500 حقيقية)</option>
                                    </select>
                                </div>
